...
function setActiveStageSection(section) {
    ...
    switch(section) {
                        ...
                        <div class="stage-section stage-about mobile-full-about">
                            <div class="mobile-about-content">
                                ...
                                <div class="mobile-contact-links">
                                    <a href="mailto:hello@tahaalfiza.com" class="mobile-contact-link">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    ...
                                    <a href="https://linkedin.com/in/tahaalfiza" target="_blank" class="mobile-contact-link">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    ...
                                    <a href="https://instagram.com/tahaalfiza" target="_blank" class="mobile-contact-link">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        case 'projects':
            ...
            setTimeout(() => {
                initStageSidebarClicks();
                if (isMobileView && typeof populateMobileCategoryFilter === 'function') {
